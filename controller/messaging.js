 ...
 * @param next method
 */
module.exports.postMessageThread=function(req, res, next) {
 ...
 * @param next method
 */
module.exports.putMessageThread=function(req, res, next) {
 ...
 * @param next method
 */
module.exports.getMessageThread=function(req, res, next) {
    if (req.session && req.session.user) {
        var noArchived = true;
 ...
 * @param next method
 */
module.exports.archiveMessageThread=function(req, res, next) {
    if (req.session && req.session.user) {
 ...
 * @param next method
 */
module.exports.postSystemMessage=function(req, res, next) {
    if (req.session && req.session.user) {
        if (!req.params.message) {
            return next(new restify.MissingParameterError('You must enter a message.'));
        }
 ...
 * @param next method
 */
module.exports.getSystemMessage=function(req, res, next) {
    if (req.session && req.session.user) {
 ...
 * @param next method
 */
module.exports.archiveSystemMessage=function(req, res, next) {
    if (req.session && req.session.user) {
 ...
 * @param next method
 */
module.exports.purgeSystemMessage=function(req, res, next) {
    if (req.session && req.session.user) {
        if (!req.params.systemMessageId) {
            return next(new restify.MissingParameterError('You must enter a System Message Id.'));
        }
